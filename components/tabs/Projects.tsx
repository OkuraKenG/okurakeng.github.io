...
export const Projects = () => {
	const projects: ListType[] = [
		{
			...
			description: "Inform the Pace University Population about the environmental conditions about their campus.",
		},
		{
			project: {
			...
			description: 'A kiosk designed to educate the public on Blue CoLabs mission and the importance of right to know.',
		},
		{
			project: {
	...
	return (
		<View>
			...
			<Text className="text-white text-lg mt-2">* More projects can be found on my <Text className="underline" onPress={() => Linking.openURL('https://github.com/okurakeng')}>GitHub</Text>.</Text>
		</View>
	)
