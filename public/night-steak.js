class NightSkyStreak {
  constructor(x, y) {
    ...
    this.terrains = [
      new Terrain(random(65, 125), random(0.001, 0.02), 50, color(1)),
      new Terrain(random(74, 80), random(0.001, 0.02), 30, color(25)),
      new Terrain(random(60, 70), random(0.001, 0.02), 5, color(40)),
      new Terrain(random(20, 30), random(0.001, 0.02), 0, color(80)),
    ];
  ...
  draw() {
    for (let i = 0; i <= windowWidth; i++) {
      ...
      line(
        ...
        x,
        document.documentElement.scrollHeight - y - this.shift
      );
    }
  }
}
