...
export default function AquaWatchPanel() {
	...
	return <div className='h-w-full h-full overflow-y-auto overflow-x-hidden text-white text-sm'>
		...
		<hr />
		<div>September 2023 - May 2024, January 2025 - Present</div>
		<hr />
		<p className='font-bold	m-0 p-0'>The Team</p>
		<p className='mt-0'>AquaWatch Mobile was a team effort (we call ourselves &apos;BlueJelly&apos;) originally developed for Software Engineering at Pace University.</p>
		...
		<p className='m-0 p-0'>The app originally relied on a webapp to host the data visualization as seen on the left. The webapp used <a href='https://shiny.posit.co/'>Shiny</a> initially written in R and later in Python.</p>
		<p>The webapp used to talk to various APIs to gather historic water data. This can later be expanded to gather current water data.</p>
		<p>As of May 2025 the data visualizations were rewritten to use Victory Native. This was done to reduce reliance on third-party services and instead have in-app solutions. The UI was also updated to better follow modern mobile app standards - including dark mode!</p>
